...
public class PrinterErrorsTest {
    ...
    public void test() {
        ...
        assertEquals("6/60", PrinterErrors.printerError(s));
        s = "kkkwwwaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbmmmmmmmmmmmmmmmmmmmxyzuuuuu";
        assertEquals("11/65", PrinterErrors.printerError(s));
    }
    ...
    public void test1() {
        ...
        for (int i = 0; i < 200; i++) {
            String s = doEx();
            assertEquals(printerErrorSol(s), PrinterErrors.printerError(s));
        }
    }
}